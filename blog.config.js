...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hermeson', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '运动 | 投资 | 科技 | 产品思考', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || '', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '个人随想', // 网站关键词 英文逗号隔开
